...
def sample_trajectories(env, policy, min_timesteps_per_batch, max_path_length, render=False, render_mode=('rgb_array')):
    ...
    while timesteps_this_batch < min_timesteps_per_batch:
        ...
        current_path = sample_trajectory(env, policy, max_path_length, render=render, render_mode=render_mode)
        current_path_length = get_pathlength(current_path)
        timesteps_this_batch += current_path_length
...
def sample_n_trajectories(env, policy, ntraj, max_path_length, render=False, render_mode=('rgb_array')):
    ...
    for idx in range(ntraj):
        sampled_paths.append(sample_trajectory(env, policy, max_path_length, render=render, render_mode=render_mode))
